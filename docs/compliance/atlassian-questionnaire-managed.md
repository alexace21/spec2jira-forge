...
- [ ] **[PARTNER: verify]** Forge purge for Managed (post-push `purgeJob`) works, and confirm the
      backstop for **abandoned/never-pushed** breakdowns (TTL or scheduled sweep) — or state the
      honest current behaviour. Do not claim a purge the code does not perform.
